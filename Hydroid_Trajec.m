...
q_ini = [flipud(q_fin(1:5)); q_fin(8:9); q_fin(6:7);q_fin(10)]; %Initial config for next step after change of feet role
qp_ini = [flipud(dq_plus(1:5)); dq_plus(8:9); dq_plus(6:7);dq_plus(10)];%dq_plus(6) is the velocity of foot1 which becomes vfoot2 after change of role
